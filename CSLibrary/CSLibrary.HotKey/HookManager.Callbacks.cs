...
namespace CSLibrary.Keyboard
{
    public static partial class KeyHookManager
    {
        ...
        /// <summary>
        /// whether allow repeat key event or only allow key changed event
        /// if false, only allow key changed event
        /// </summary>
        public static bool bDetectMultipleKey = false;
        ...
        private static int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0)
            {
                ...
                if (s_KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                {
                    ...
                    if (bDetectMultipleKey)
                        s_KeyDown.Invoke(null, e);
                    else if (LastKey != WM_KEYDOWN && LastKey != WM_SYSKEYDOWN)
                    {
                        s_KeyDown.Invoke(null, e);
                    }
                ...
                if (s_KeyUp != null && (wParam == WM_KEYUP || wParam == WM_SYSKEYUP))
                {
                    ...
                    else if (LastKey != WM_KEYUP && LastKey != WM_SYSKEYUP)
                    {
                        s_KeyUp.Invoke(null, e);
                    }
