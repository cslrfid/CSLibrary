...
namespace CSLibrary.Barcode.Structures
{
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public class SerialPortParms : ConfigBase
    {
        /// <summary>
        /// Baud rate
        /// </summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public class ImagerCapabilitiesParms
    {
        /// <summary>
        /// Structure size
        /// </summary>
        protected UInt32 dwStructSize = 24;
        /// <summary>
        /// Size of image captured by imager before cropping and subsampling.
        /// </summary>
        public SIZE fullImgSize;
        /// <summary>
        /// Bits per pixel of image captured by imager.
        /// </summary>
        public UInt32 dwImgrBpp;
        /// <summary>
